...
return {
  ...
  config = function()
    ...
    require("diffview").setup({
      ...
      view = {
        default = {
          layout = "diff2_horizontal", -- Side-by-side diff view like VS Code
          winbar_info = false,
        },
        merge_tool = {
      ...
      keymaps = {
        ...
        diff2 = {
          ...
          },
          {
            "n",
            "dp",
            actions.diffput("ours"),
            { desc = "Put the diff hunk to the OURS version of the file" },
          },
          {
            "n",
            "<leader>co",
        ...
        diff3 = {
          ...
          },
          {
            { "n", "x" },
            "3dp",
            actions.diffput("theirs"),
            { desc = "Put the diff hunk to the THEIRS version of the file" },
          },
        },
        diff4 = {
          {
          ...
          },
          {
            { "n", "x" },
            "1dp",
            actions.diffput("base"),
            { desc = "Put the diff hunk to the BASE version of the file" },
          },
          {
            { "n", "x" },
            "2dp",
        ...
        file_history_panel = {
          ...
          },
          {
            ...
            "y",
            actions.copy_hash,
            { desc = "Copy the commit hash under the cursor" },
          },
          {
            "n",
            "L",
          ...
          },
          {
            ...
            "o",
            actions.select_entry,
            { desc = "Open the diff for the diff for the selected entry" },
          },
          {
            "n",
            "<2-LeftMouse>",
